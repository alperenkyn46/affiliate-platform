...
const socialIcons = {
  ...
  kick: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M1.333 0v24h8v-8h5.334l2.666 2.667V24h5.334v-8L20 13.333 22.667 8V0H1.333zm16 9.333L14.667 12H9.333V5.333h8v4z"/>
    </svg>
  ),
  youtube: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Header() {
  ...
  const socialLinks = [
    { name: "Discord", href: settings.socialDiscord, icon: socialIcons.discord },
    { name: "Telegram", href: settings.socialTelegram, icon: socialIcons.telegram },
    { name: "Twitch", href: settings.socialTwitch, icon: socialIcons.twitch },
    { name: "Kick", href: settings.socialKick, icon: socialIcons.kick },
    { name: "YouTube", href: settings.socialYoutube, icon: socialIcons.youtube },
  ];
          ...
          <nav className="hidden md:flex items-center gap-1">
            {socialLinks.map((link) => (
              <Link
                ...
                className="p-3 rounded-lg text-gray-400 hover:text-gold hover:bg-white/5 transition-all duration-200"
                title={link.name}
              >
                {link.icon}
              </Link>
